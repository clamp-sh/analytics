...
/** A single event property value. String, finite number, boolean, or `Money`. */
export type EventPropertyValue = string | number | boolean | Money;

/** Property bag attached to a tracked event. */
export type EventProperties = Record<string, EventPropertyValue>;

/** Function signature each extension consumes to send events. */
